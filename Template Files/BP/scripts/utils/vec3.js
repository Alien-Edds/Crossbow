...
var Vector3Utils = class _Vector3Utils {
  ...
  static add(v1, v2) {
    var _a, _b, _c;
    return { x: v1.x + ((_a = v2.x) != null ? _a : 0), y: v1.y + ((_b = v2.y) != null ? _b : 0), z: v1.z + ((_c = v2.z) != null ? _c : 0) };
  }
  /**
   * subtract
   *
   ...
   */
  static magnitude(v) {
    return Math.sqrt(__pow(v.x, 2) + __pow(v.y, 2) + __pow(v.z, 2));
  }
  /**
   * distance
   *
  ...
  static toString(v, options) {
    var _a, _b;
    const decimals = (_a = options == null ? void 0 : options.decimals) != null ? _a : 2;
    const str = [v.x.toFixed(decimals), v.y.toFixed(decimals), v.z.toFixed(decimals)];
    return str.join((_b = options == null ? void 0 : options.delimiter) != null ? _b : ", ");
  }
  /**
   * fromString
   *
  ...
  static clamp(v, limits) {
    ...
    return {
      x: clampNumber(v.x, (_b = (_a = limits == null ? void 0 : limits.min) == null ? void 0 : _a.x) != null ? _b : Number.MIN_SAFE_INTEGER, (_d = (_c = limits == null ? void 0 : limits.max) == null ? void 0 : _c.x) != null ? _d : Number.MAX_SAFE_INTEGER),
      y: clampNumber(v.y, (_f = (_e = limits == null ? void 0 : limits.min) == null ? void 0 : _e.y) != null ? _f : Number.MIN_SAFE_INTEGER, (_h = (_g = limits == null ? void 0 : limits.max) == null ? void 0 : _g.y) != null ? _h : Number.MAX_SAFE_INTEGER),
      z: clampNumber(v.z, (_j = (_i = limits == null ? void 0 : limits.min) == null ? void 0 : _i.z) != null ? _j : Number.MIN_SAFE_INTEGER, (_l = (_k = limits == null ? void 0 : limits.max) == null ? void 0 : _k.z) != null ? _l : Number.MAX_SAFE_INTEGER)
    };
  }
  /**
   * lerp
...
var Vector3Builder = class {
  constructor(first, second, z) {
    ...
    if (typeof first === "object") {
      ...
      const parsed = Vector3Utils.fromString(first, ",");
      if (!parsed) {
        this.x = 0;
        this.y = 0;
        this.z = 0;
...
var Vector2Builder = class {
  constructor(first, second) {
    ...
    if (typeof first === "object") {
      ...
      const parsed = Vector2Utils.fromString(first, ",");
      if (!parsed) {
        this.x = 0;
        this.y = 0;
        return;
